...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileZooKeeperOperator{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
// ReconcileZooKeeperOperator reconciles a ZooKeeperOperator object
...
func (r *ReconcileZooKeeperOperator) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set ZooKeeperOperator instance as the owner and controller
...
func newPodForCR(cr *kafkav1alpha1.ZooKeeperOperator) *corev1.Pod {
